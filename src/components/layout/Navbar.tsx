        ...
        <nav className="py-8 flex flex-wrap items-center justify-around p-2 h-20 bg-pessego">
            ...
            <ul className="md:flex justify-around list-none text-center text-slate-950 hidden">
                ...
                {menuItems.map(menu => (
                    ...
                    <li className="font-gfs-didot opacity-90 mr-10"> <a className="font-medium hover:underline hover:underline-offset-4 text-2xl	" href={ `#${menu.title}` } > { menu.title } </a> </li>
