...
const Select = ({text, name, options, value, onChange }: selects) => {
  ...
  return (
    ...
    <div>
        ...
        <select className="opacity-50 w-[80vw] sm:w-[60vw] md:w-[40vw] lg:w-[30vw] p-2 border-none outline-none rounded-2xl relative" value={value} name={name} id={value} onChange={onChange}> <br />
