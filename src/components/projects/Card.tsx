...
function Card( {title, img, description, language} : cards) {
    ...
    return(
        ...
        <div className="flex-col w-[80vw] lg:w-[25vw] md:flex lg:flex xl:flex  lg:h-[68vh] md:w-[45vw] md:h-[54vh] justify-center flex-wrap rounded-[15%] bg-slate-white h-auto md:w-25 font-gfs-didot text-center transition hover:-translate-y-1 hover:scale-110 duration-300">

            <div className="h-[45vh] md:h-[54vh]  lg:h-[68vh] xl:h-[68vh]">
